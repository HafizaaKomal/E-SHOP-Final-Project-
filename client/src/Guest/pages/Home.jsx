      ...
      <Carousel>
        <Carousel.Item>
          <img
            ...
            src="https://images.unsplash.com/photo-1604242692760-2f7b0c26856d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8d2F0Y2hlc3xlbnwwfHwwfHx8MA%3D%3D&w=1000&q=80"
            alt="First slide"
          />
        </Carousel.Item>
        <Carousel.Item>
        ...
        <Carousel.Item>
          <img
            className="d-block w-100"
            src="https://hips.hearstapps.com/hmg-prod/images/diy-home-decor-2-1668725383.png"
            alt="Third slide"
          />
        </Carousel.Item>
        <Carousel.Item>
          <img
            className="d-block w-100"
            src="https://images.unsplash.com/photo-1554047310-ab6170fc7b10?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8d2VkZGluZyUyMHJpbmd8ZW58MHx8MHx8fDA%3D&w=1000&q=80"
            alt="Fourth slide"
          />
        </Carousel.Item>
      </Carousel>
            ...
            <div className="col-md-4 col-sm-6 mb-4 text-center">
              <div className="card-container">
                ...
                <div className="product-details">
                  ...
                  <AiFillStar></AiFillStar>
                  <BsStarHalf></BsStarHalf>
                  <h5 className="card__price">$26</h5>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="card-row row justify-content-center">
            <div className="col-md-3 col-sm-6 mb-4 text-center">
              <article className="custom-card card1">
                <div className="custom-card__body">
                  ...
                  <p>Incharge</p>
                  <div className="icons">
                    <i className="icon icon--github"><a href="https://github.com/HafizaaKomal"><AiFillGithub></AiFillGithub></a></i>
                    <i className="icon icon--instagram"><a href="https://www.instagram.com/__.komal91__/"><BsInstagram></BsInstagram></a></i>
                    <i className="icon icon--linkedin"><a href="https://www.linkedin.com/in/hafiza-komal-shamsi-79156a267/"><BsLinkedin></BsLinkedin></a></i>
                  </div>
                </div>
              </article>
            </div>
            ...
            <div className="col-md-3 col-sm-6 mb-4 text-center">
              <article className="custom-card card2">
                <div className="custom-card__body">
                  <h2 className="custom-card__title">Ali</h2>
                  <p>HOD</p>
                  <div className="icons">
                    <i className="icon icon--github"><a href="https://github.com/HafizaaKomal"><AiFillGithub></AiFillGithub></a></i>
                    <i className="icon icon--instagram"><a href="https://www.instagram.com/__.komal91__/"><BsInstagram></BsInstagram></a></i>
